...
all = [
		{'src': './project/src',     'dst':'./project/packages/debian/usr/lib/erlang/lib/transmission-%s/src'},	   
		{'src': './project/ebin',    'dst':'./project/packages/debian/usr/lib/erlang/lib/transmission-%s/ebin'},
		##{'src': './project/include', 'dst':'./project/packages/debian/usr/lib/erlang/lib/transmission-%s/include'},
		]
...
class targets(object):
	...
	def debian(cls):
		...
		try:
			...
			shutil.copy("./project/etrx",         path)
			shutil.copy("./project/etrx_control", path)
